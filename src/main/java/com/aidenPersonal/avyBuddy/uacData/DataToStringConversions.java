...
/**
 * This class merely helps to convert the data found in Forecast and Route to
 * readable Strings.
 * 
 * Also contains the SQL connection string for the database because this felt
...
public class DataToStringConversions {
    ...
    // Hash map that takes an integer as a key and gives the appropriate aspect
    // value as a string
    ...
    // Hash map that takes an integer as a key and gives the appropriate elevation
    // value as a string

    // Hash map that takes an integer as a key and returns the appropriate elevation
    // value as a string
    ...
    // Hash map that takes an integer as a key and giver the appropriate danger
    // value as a string
    // Hash map that takes an integer as a key and returns the appropriate danger
    // value as a string
     ...
     * 
     * @param jsonObject JsonNode-type object that contains the comma-seperated
     *                   string
    ...
    /**
     * This method does the same thing as commaSeperatedStringToIntArray, but
     * instead of converting to an
     * int array it converts to a boolean array where if the int is >= 1 it puts
     * true for that index and
     * 0 if else. It also takes a string as an input instead (for use by the
     * database)
     * 
     * @param commaSeperatedString string to be converted to
     * @return seperatedBooleanArray as described above, to be used for creating
     *         route objects from
    ...
    /**
     * This method returns the textual representation of the index of an aspect as a
     * string
     * 
    ...
    /**
     * This method returns the textual representation of the index of an elevation
     * as a string
     * 
    ...
    /**
     * Combination of getAspectString and getElevationString, to get textual
    ...
    /**
     * returns what a danger value means textually as defined by the Utah Avalanche
     * Center
     * 
