...
function getRegionFromUrlAccount() {
...
function makeRouteContainerAccount(route) {
    // Outer container
...
function makeDividingLineAccount() {
    const divider = document.createElement('hr');
    divider.classList.add('dividingLine');
    return divider;
}
function makeErrorContainerAccount(errObj) {
...
function getRouteListFromEndpointAccount(apiEndpoint) {
