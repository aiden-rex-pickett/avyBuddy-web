...
// regions in the nginx config, the backend, and addRoute.ts maybe look into this and find some way to do the check of if we are on a valid page without this list, maybe by some huristic about the state of the dom to see the differences between 
