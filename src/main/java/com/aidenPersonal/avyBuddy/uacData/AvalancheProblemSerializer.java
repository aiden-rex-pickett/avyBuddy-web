...
/**
 * Serializer for the AvalancheProblem class so it can be created as an
 * ObjectNode
 *
...
public class AvalancheProblemSerializer extends JsonSerializer<AvalancheProblem> {
    @Override
    public void serialize(AvalancheProblem avalancheProblem, JsonGenerator gen, SerializerProvider serializerProvider)
            throws IOException {
